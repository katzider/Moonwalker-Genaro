...
// Miku
const int maxKF2=3;				//Num. total de KeyFrames para la secuencia 1 (caminar)
FRAME KeyFrame2[maxKF1];		//Contenedor para almacenar cada keyframe de la secuencia 1
bool play2 = true;//Bandera para iniciar la animaci�n
int playIndex2 = 0;//Auxiliar para leer la informaci�n del contenedor de keyframes

const int maxKF3=3;				//Num. total de KeyFrames para la secuencia 1 (caminar)
FRAME KeyFrame3[maxKF1];		//Contenedor para almacenar cada keyframe de la secuencia 1
bool play3 = true;//Bandera para iniciar la animaci�n
int playIndex3 = 0;//Auxiliar para leer la informaci�n del contenedor de keyframes
...
GLfloat LightPos[] = { 200.0f, 20.0f, 0.0f, 1.0f};		// Posici�n de la luz
...
void DatosAnimacion()
{
	...
	// Miku       
	KeyFrame2[ 0 ].Angt1 = 0.0f;	KeyFrame2[ 1 ].Angt1 =	0.0f;	KeyFrame2[ 2 ].Angt1 = 0.0f;
	KeyFrame2[ 0 ].Angt2 =	0.0f;	KeyFrame2[ 1 ].Angt2 =	0.0f;	KeyFrame2[ 2 ].Angt2 =	0.0f;
	KeyFrame2[ 0 ].Angc1 =	-25.0f;	KeyFrame2[ 1 ].Angc1 =	-25.0f;	KeyFrame2[ 2 ].Angc1 =	-25.0f;
	KeyFrame2[ 0 ].Angc2 =	0.0f;	KeyFrame2[ 1 ].Angc2 =	0.0f;	KeyFrame2[ 2 ].Angc2 =	0.0f;
	KeyFrame2[ 0 ].Angbi1=	-5.0f;	KeyFrame2[ 1 ].Angbi1=	-5.0f;	KeyFrame2[ 2 ].Angbi1=	-5.0f;
	KeyFrame2[ 0 ].Angbi2=	0.0f;	KeyFrame2[ 1 ].Angbi2=	0.0f;	KeyFrame2[ 2 ].Angbi2=	0.0f;
	KeyFrame2[ 0 ].Angbib=	-15.0f;	KeyFrame2[ 1 ].Angbib=	-15.0f;	KeyFrame2[ 2 ].Angbib=	-15.0f;
	KeyFrame2[ 0 ].Angbd1=	5.0f;	KeyFrame2[ 1 ].Angbd1=	5.0f;	KeyFrame2[ 2 ].Angbd1=	5.0f;
	KeyFrame2[ 0 ].Angbd2=	0.0f;	KeyFrame2[ 1 ].Angbd2=	0.0f;	KeyFrame2[ 2 ].Angbd2=	0.0f;
	KeyFrame2[ 0 ].Angbdb=	-40.0f;	KeyFrame2[ 1 ].Angbdb=	-40.0f;	KeyFrame2[ 2 ].Angbdb=-40.0f;
	KeyFrame2[ 0 ].Angpizq=20.0f;	KeyFrame2[ 1 ].Angpizq=20.0f;	KeyFrame2[ 2 ].Angpizq=20.0f;
	KeyFrame2[ 0 ].Angpder=-20.0f;	KeyFrame2[ 1 ].Angpder=-20.0f;	KeyFrame2[ 2 ].Angpder=-20.0f;
	KeyFrame2[ 0 ].Angpizqb=15.0f;	KeyFrame2[ 1 ].Angpizqb=15.0f;	KeyFrame2[ 2 ].Angpizqb=15.0f;
	KeyFrame2[ 0 ].Angpderb=10.0f;	KeyFrame2[ 1 ].Angpderb=10.0f;	KeyFrame2[ 2 ].Angpderb=10.0f;
	KeyFrame2[ 0 ].Angpi =	0.0f;	KeyFrame2[ 1 ].Angpi =	0.0f;	KeyFrame2[ 2 ].Angpi =	0.0f;
	KeyFrame2[ 0 ].Angpd =	0.0f;	KeyFrame2[ 1 ].Angpd =	0.0f;	KeyFrame2[ 2 ].Angpd =	0.0f;
	KeyFrame2[ 0 ].Xtor  =	0.0f;	KeyFrame2[ 1 ].Xtor  =	0.0f;	KeyFrame2[ 2 ].Xtor  =	0.0f;
	...
	// Enem1 (enemigo gordo)
	KeyFrame3[ 0 ].Angt1 =	0.0f;	KeyFrame3[ 0 ].Angt1 =	0.0f;	KeyFrame3[ 2 ].Angt1 = 0.0f;
	KeyFrame3[ 0 ].Angt2 =	5.0f;	KeyFrame3[ 1 ].Angt2 =	0.0f;	KeyFrame3[ 2 ].Angt2 =	-5.0f;
	KeyFrame3[ 0 ].Angc1 =	-20.0f;	KeyFrame3[ 1 ].Angc1 =	20.0f;	KeyFrame3[ 2 ].Angc1 =	-20.0f;
	KeyFrame3[ 0 ].Angc2 =	0.0f;	KeyFrame3[ 1 ].Angc2 =	0.0f;	KeyFrame3[ 2 ].Angc2 =	0.0f;
	KeyFrame3[ 0 ].Angbi1= -8.0f;	KeyFrame3[ 1 ].Angbi1=	8.0f;	KeyFrame3[ 2 ].Angbi1=	-8.0f;
	KeyFrame3[ 0 ].Angbi2= 0.0f;	KeyFrame3[ 1 ].Angbi2=	0.0f;	KeyFrame3[ 2 ].Angbi2=	0.0f;
//	KeyFrame3[ 0 ].Angbib= 0.0f;	KeyFrame3[ 1 ].Angbib=	-15.0f;	KeyFrame3[ 2 ].Angbib=	-15.0f;
	KeyFrame3[ 0 ].Angbd1= 8.0f;	KeyFrame3[ 1 ].Angbd1=	8.0f;	KeyFrame3[ 2 ].Angbd1=	8.0f;
	KeyFrame3[ 0 ].Angbd2= 0.0f;	KeyFrame3[ 1 ].Angbd2=	0.0f;	KeyFrame3[ 2 ].Angbd2=	0.0f;
//	KeyFrame3[ 0 ].Angbdb= 0.0f;	KeyFrame3[ 1 ].Angbdb=	-40.0f;	KeyFrame3[ 2 ].Angbdb=	-40.0f;
	KeyFrame3[ 0 ].Angpizq=15.0f;	KeyFrame3[ 1 ].Angpizq=-10.0f;	KeyFrame3[ 2 ].Angpizq=15.0f;
	KeyFrame3[ 0 ].Angpder=-10.0f;	KeyFrame3[ 1 ].Angpder=15.0f;	KeyFrame3[ 2 ].Angpder=-10.0f;
	KeyFrame3[ 0 ].Angpizqb=-5.0f;	KeyFrame3[ 1 ].Angpizqb=10.0f;	KeyFrame3[ 2 ].Angpizqb=-5.0f;
	KeyFrame3[ 0 ].Angpderb=10.0f;	KeyFrame3[ 1 ].Angpderb=-5.0f;	KeyFrame3[ 2 ].Angpderb=10.0f;
